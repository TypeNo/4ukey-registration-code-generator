...
def args_parser():
    ...
    # parser.add_argument('--train_img', type=str, default='PKLot/PKLotSegmented/UFPR04/Cloudy/', help="path to training set images")
    parser.add_argument('--train_lab', type=str, default='splits/CNRParkAB/all.txt', help="path to training set labels")
    # parser.add_argument('--train_lab', type=str, default='splits/PKLot/UFPR05.txt', help="path to training set labels")
